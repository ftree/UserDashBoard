 ...
 *
 */
function UserDashBoard_Sideblock_init()
{
 ...
 */
function UserDashBoard_Sideblock_display($blockinfo)
{
	...
	if ($edit) {
		$plugins 	= pnModAPIFunc('UserDashBoard','user','getOpenPlugins', array('onlySingle' => true));
	} else {
		$plugins 	= "";
	}
	...
	return $render->fetch('UserDashBoard_block_side.htm');
